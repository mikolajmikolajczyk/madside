...
Claude-specific entry point. Body lives in [`AGENTS.md`](AGENTS.md) — same canonical content is consumed by every other coding agent.
...
into `jq`. Working tree: `/home/mikolaj/src/madside`.
