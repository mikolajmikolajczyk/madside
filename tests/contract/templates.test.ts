...
describe('project templates', () => {
  ...
  it('lists the bundled templates with display metadata, ordered', () => {
    ...
    expect(list.map((t) => t.id)).toEqual(['atari-hello', 'nes-hello', 'atari-130xe-bank', 'nes-apu-hello', 'nes-c-hello', 'atari-c-hello', 'nes-banking', 'c64-c-hello', 'c64-hello', 'empty', 'genesis-asm-hello', 'zx-asm-hello', 'zx-c-hello'])
