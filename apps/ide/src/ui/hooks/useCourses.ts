...
import { coursesSnapshot, hydrateRemoteCourses, subscribeCourses, useWorkbench, type CourseInfo } from "@app";
...
export function useCourses(): CourseInfo[] {
  ...
  useEffect(() => { void hydrateRemoteCourses(workbench.storage); }, [workbench]);
